...
<section class="dashboard">
   ...
   <h1 class="heading">Quản lý chung</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Đơn hàng đã đặt</p>
         <a href="placed_orders.php" class="btn">Quản lý đơn hàng đã đặt</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Thêm sản phẩm</p>
         <a href="products.php" class="btn">Quản lý sản phẩm thêm</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Người dùng</p>
         <a href="users_accounts.php" class="btn">Quản lý tài khoản người dùng</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Tài khoản admin</p>
         <a href="admin_accounts.php" class="btn">Quản lý tài khoản admin</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Tin nhắn</p>
         <a href="messages.php" class="btn">Xem liên hệ khách hàng</a>
      </div>
