...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="Xóa khỏi yêu thích" onclick="return confirm('Bạn chắc chắn muốn xoá khỏi yêu thích không ?');" class="delete-btn" name="delete">
   </form>
   <?php
      }
   }else{
   ...
   <div class="wishlist-total">
      <p>Tổng thành tiền : <span><?= number_format($grand_total, 0, ',', '.'); ?> VNĐ</span></p>
